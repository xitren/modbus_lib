 ...
 * @par Example
 * @code{.cpp}
 * xitren::modbus::read_bits<10> cmd(1, 100, [](auto err, auto begin, auto end) {
 ...
 * @endcode
 */
class read_bits : public command {
public:
    /**
     * @brief Constructs a new read bits command.
     *
     * @param slave The device ID to read from.
    ...
    {
        static_assert(command::command_buffer_max >= sizeof(read_bits),
    ...
    /**
     * @brief Destroys the read bits command.
     */
