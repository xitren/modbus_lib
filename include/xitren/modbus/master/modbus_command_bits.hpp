...
public:
    write_bit(std::uint8_t slave, std::uint16_t address, bool val) noexcept : write_bit{slave, address, val, nullptr} {}
...
public:
    ...
    write_bits(std::uint8_t slave, std::uint16_t address, std::array<bool, Size> const& vals) noexcept
