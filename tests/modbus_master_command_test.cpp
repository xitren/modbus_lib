#include "loveka/components/modbus/master/modbus_command_bits.hpp"
#include "loveka/components/modbus/master/modbus_command_regs.hpp"
...
bool
arrays_match(const std::array<T, Size>& expected, const std::array<T, Size1>& actual,
             std::size_t size)
{
...
TEST(modbus_master_command_test, modbus_master_read_coils)
{
    ...
    read_bits t1(address, 0, 8,
                 [&](exception, types::bits_array_type::iterator begin,
                     types::bits_array_type::iterator end) mutable {
...
TEST(modbus_master_command_test, modbus_master_read_inputs)
{
    ...
    read_input_bits t1(address, 0, 8,
                       [&](exception, types::bits_array_type::iterator begin,
                           types::bits_array_type::iterator end) mutable {
